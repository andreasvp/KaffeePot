...
void createKaffeeCsv() 
{
	...
	sdout << F(
			...
			"87594C39,Mitarbeiter2,Entwicklung,40,01:08:14,23.06.16\n"
			"CAB49116,Mitarbeiter3,Qualitätssicherung,10,01:08:14,23.06.16\n"
			"296E2887,Mitarbeiter4,Entwicklung,40,01:08:14,23.06.16\n"
			"FA695AA9,Mitarbeiter5,Entwicklung,40,01:08:14,23.06.16\n"
			...
			"F7EBF7E5,Mitarbeiter8,Entwicklung,40,01:08:14,23.06.16\n") << flush;
...
char char_cardid[str_len];

// Copy it over
cardId.toCharArray(char_cardid, str_len);

	SFPRINTLN("<Start addKaffeeCsvEntry()>");
	...
	while (1) {
		...
		// relevante Abteilung
		if (strcmp(char_cardid,uidField)==0){
          SFPRINTLN("Found")
		  Serial.println(nameField);



            countCoffeeuser = kaffeeAnzahl;
		}
	...
	SFPRINTLN("<End addKaffeeCsvEntry()>");

	return countCoffeeuser+1;
}
